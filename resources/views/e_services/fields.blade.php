...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Categories Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('categories[]', trans('lang.e_service_categories'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            {!! Form::select('categories[]', $category, $categoriesSelected, [
                'class' => 'select2 form-control not-required',
                'data-empty' => trans('lang.e_service_categories_placeholder'),
                'multiple' => 'multiple',
            ]) !!}
    ...
    <!-- Price Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('price', trans('lang.e_service_price'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('discount_price', trans('lang.e_service_discount_price'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            <div class="input-group">
    ...
    <!-- Price Unit Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('price_unit', trans('lang.e_service_price_unit'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            {!! Form::select(
                'price_unit',
                ['hourly' => trans('lang.e_service_price_unit_hourly'), 'fixed' => trans('lang.e_service_price_unit_fixed')],
                null,
    ...
    <!-- Quantity Unit Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('quantity_unit', trans('lang.e_service_quantity_unit'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            {!! Form::text('quantity_unit', null, [
                'class' => 'form-control',
    ...
    <!-- Duration Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('duration', trans('lang.e_service_duration'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            <div class="input-group timepicker duration" data-target-input="nearest">
                {!! Form::text('duration', null, [
                    ...
                    'data-target' => '.timepicker.duration',
    ...
    <!-- E Provider Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('e_provider_id', trans('lang.e_service_e_provider_id'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            {{-- {!! Form::select('e_provider_id[]', $eProvider, null, ['class' => 'select2 form-control','multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.e_service_e_provider_id_help") }}</div> --}}
            {{-- provider_services --}}
            <select name="e_provider_id[]" class="select2 form-control" multiple="multiple" id="">
                @foreach ($eProvider as $key => $item)
                    <option value="{{ $key }}"
...
<div class="form-group align-items-start d-flex flex-column flex-md-row">
    {!! Form::label('image', trans('lang.e_service_image'), [
        'class' => 'col-md-3 control-label text-md-right mx-1',
    ]) !!}
    <div class="col-md-9">
        ...
        var dz_var16110647911349350349ble = $(".dropzone.image").dropzone({
            ...
            removedfile: function(file) {
                dzRemoveFileMultiple(
                    ...
                    'image', '{!! isset($eService) ? $eService->id : 0 !!}', '{!! url('uploads/clear') !!}',
                    '{!! csrf_token() !!}'
                );
            }
        });
...
<!-- Description Field -->
<div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
    {!! Form::label('description', trans('lang.e_service_description'), [
        'class' => 'col-md-3 control-label text-md-right mx-1',
    ]) !!}
    <div class="col-md-9">
        {!! Form::textarea('description', null, [
            'class' => 'form-control',
            'placeholder' => trans('lang.e_service_description_placeholder'),
        ]) !!}
...
<div class="d-flex flex-row justify-content-between align-items-center">
    {!! Form::label(
        'enable_booking',
        trans('lang.e_service_enable_booking'),
...
<a href="{!! route('eServices.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
    {{ trans('lang.cancel') }}</a>
</div>
