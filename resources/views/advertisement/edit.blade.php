            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @can('advertisement.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('advertisement.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.advertisement_create')}}</a>
                        </li>
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-edit mr-2"></i>{{trans('lang.advertisement_edit')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                {!! Form::model($advertisement, ['route' => ['advertisement.update', $advertisement->id], 'method' => 'patch']) !!}
                <div class="row">
