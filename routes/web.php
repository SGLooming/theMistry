...
Route::middleware('auth')->group(function () {
    ...
    Route::get('eProviders/{provider_id}/services', [App\Http\Controllers\EProviderController::class, 'services'])->name('eProviders.services');
    Route::post('eProviders/{provider_id}/services/{service_id}', [App\Http\Controllers\EProviderController::class, 'services_delete'])->name('eProviders.services.delete');
    ...
    Route::post('advertisements/remove-media', 'AdvertisementController@removeMedia');
